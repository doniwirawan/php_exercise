  ...
  <body>
    ...
    <div class="col-lg-4 xs-auto mt-lg-5 border p-4 rounded">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputPassword1" name="gaji_pokok">
        </div>

        <div class="form-group">
            <label for="exampleInputPassword1">Tunjangan</label>
            <input type="number" class="form-control" id="exampleInputPassword1" name="tunjangan">
        </div>    
